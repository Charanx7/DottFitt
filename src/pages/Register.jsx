...
//                 backdrop-blur-sm text-white placeholder-gray-400 resize-none"
//       required={required}
//     />
//   </div>
// );
...
//       ) : (
//         <span className={`font-semibold ${current ? 'text-white' : 'text-gray-300'}`}>
//           {index + 1}
//         </span>
//       )}
//     </div>
//     <span className="text-xs mt-2 text-gray-400 text-center max-w-20 hidden md:block">
//       {title.split(' ')[0]}
//     </span>
//   </div>
// );
...
//   <div className={`w-16 h-1 mx-2 mt-5 transition-all duration-500 ${
...
//       0: ['fullName', 'age', 'gender', 'height', 'weight', 'occupation', 'contact'],
...
//       question_fullName: "Full Name",
//       question_age: "Age",
//       question_gender: "Gender",
//       question_height: "Height",
//       question_weight: "Weight",
//       question_occupation: "Occupation",
//       question_contact: "Contact Information (User Email)",
//       question_medicalConditions: "Existing medical conditions (e.g., diabetes, hypertension, asthma)",
//       question_medications: "Medications or supplements",
//       question_injuries: "Any injuries or surgeries in the past year",
//       question_jointPain: "Joint pain or mobility issues",
//       question_doctorAdvice: "Any doctor's advice not to exercise",
//       question_sleepHours: "How many hours do you sleep per night?",
//       question_smoking: "Do you smoke?",
//       question_alcohol: "Do you consume alcohol?",
//       question_alcoholFrequency: "How often?",
//       question_activityLevel: "Activity level",
//       question_currentlyExercising: "Are you currently exercising?",
//       question_goals: "Primary fitness goals",
//       question_timeline: "Desired timeline to reach your goals",
//     };
//     emailjs.send(
//       "service_uxlkdbk",       // <-- Your EmailJS Service ID (replace here)
//       "template_wa1u312",      // <-- Your EmailJS Template ID (replace here)
//       emailPayload,
//       "XVJuEsRB2iXS9Tu0P"        // <-- Your EmailJS Public Key (replace here)
//     )
//       .then(() => {
//         alert('Fitness Assessment Submitted Successfully!');
//         setFormData({
//           fullName: '', age: '', gender: '', height: '', weight: '', occupation: '', contact: '',
...
//               <span className="text-sm font-semibold">FITNESS ASSESSMENT</span>
//             </div>
...
//           <span className="text-blue-400 font-semibold text-lg">{sections[currentSection].title}</span>
//           <div className="flex items-center justify-center space-x-2 text-gray-400 text-sm mt-1">
...
//                     <InputField label="Email Address" type="email" value={formData.contact} name="contact" onChange={e => handleInputChange('contact', e.target.value)} placeholder="Enter your email address" />
//                   </div>
//                 </div>
//               </div>
//             )}
...
//               <div className="space-y-6">
//                 <div>
//                   <label className="block text-sm font-medium text-gray-300 mb-4">What are your primary goals? (Choose all that apply) *</label>
...
//               <button type="button" onClick={() => setCurrentSection(prev => prev - 1)} disabled={currentSection === 0} className="flex items-center space-x-2 px-6 py-3 rounded-xl bg-gray-700/50 hover:bg-gray-600/50 disabled:opacity-30 disabled:cursor-not-allowed transition-all duration-300 border border-gray-600 hover:border-gray-500">
...
//                 <span className="text-sm text-gray-400">{currentSection + 1} of {sections.length}</span>
                
//                 {currentSection === sections.length - 1 ? (
//                   <button type="submit" disabled={!isCurrentSectionComplete()} className="flex items-center space-x-2 px-8 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105 shadow-lg shadow-blue-500/25">
//                     <span>Complete Assessment</span>
//                     <ChevronRight className="w-4 h-4" />
//                   </button>
//                 ) : (
//                   <button type="button" onClick={() => setCurrentSection(prev => prev + 1)} disabled={!isCurrentSectionComplete()} className="flex items-center space-x-2 px-8 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105 shadow-lg shadow-blue-500/25">
//                     <span>Continue</span>
//                     <ChevronRight className="w-4 h-4" />
//                   </button>
//                 )}
...
const FitnessAssessmentForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const emailPayload = {
      ...
      contact: formData.email, // This matches your email template variable
      contactNumber: formData.contactNumber, // This matches your email template variable
    ...
    emailjs.send(
      "service_jj0yb24",       // Your EmailJS Service ID
      "template_zjyj4ug",      // Your EmailJS Template ID
      emailPayload,
      "TOg3FSHAZlLd7OE21"      // Your EmailJS Public Key
    )
      .then(() => {
        alert('Fitness Assessment Submitted Successfully!');
        setFormData({
